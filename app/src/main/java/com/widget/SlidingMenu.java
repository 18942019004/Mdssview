...
//                return super.onTouchEvent(ev);
    ...
    void finishDrag()
    {
        try
        {
            Class parentClass = Class.forName("android.widget.HorizontalScrollView");
            Field beingDragged = parentClass.getDeclaredField("mIsBeingDragged");
            beingDragged.setAccessible(true);
            beingDragged.set(this,false);
        }
...
//         L.e("scale" + scale + " leftScale" + leftScale + " rightScale" +
//                 rightScale);
    ...
    {
        horizontalScrollOffset = super.computeHorizontalScrollOffset();

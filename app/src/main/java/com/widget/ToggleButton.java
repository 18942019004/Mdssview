...
public class ToggleButton extends View
{
	...
	/** 开启颜色 */
	private int onColor = Color.parseColor("#00ff00");

	/** 关闭颜色 */
	private int offBorderColor = Color.parseColor("#c9c9c9");
	...
	/**
	 * 设置开启关闭样式 不处罚toggle事件
	 * 
	 * @param toggleOn
	 */
	public void setToggle(boolean toggleOn)
	{
		if (toggleOn)
		{
			setToggleOn();

...
public class WheelView extends View
{
    ...
    /**
     * Sets the current item. Does nothing when canvasIndex is wrong.
     *
     * @param index    the item canvasIndex
    ...
    /**
     * Sets the current item w/o animation. Does nothing when canvasIndex is wrong.
     *
     * @param index the item canvasIndex
     */
    ...
    /**
     * Returns text item by canvasIndex
     *
     * @param index the item canvasIndex
     *
    ...
    private int calculateLayoutWidth(int widthSize,int mode)
    {
        ...
        itemsWidth = widthSize - labelWidth;
        ...
        // itemsWidth = (int) newWidthItems - 12;
